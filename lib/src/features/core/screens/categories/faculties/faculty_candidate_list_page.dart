...
class FacultyCandidateListPage extends StatelessWidget {
  final String category;
  final String voterEmail;

  const FacultyCandidateListPage(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(category),
        // body: Center(
        //   child: Text('List of $category Candidates'),
        // ),
      ),
                        ...
                        return SfCircularChart(
                          series: <CircularSeries>[
                            PieSeries<CandidateGRC, String>(
                              ...
                              dataLabelMapper: (CandidateGRC data, _) =>
                                  '${data.nameGRC}: ${data.votesGRC}',
                            ),
                          ],
                        );
                      }
